...
class UserImportForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields.values():
            _bootstrap_widget(field)
        self.fields["import_file"].widget.attrs.update({"accept": ".json,.xlsx,.xls"})
    ...
    def clean_import_file(self):
        ...
        if not (filename.endswith(".xlsx") or filename.endswith(".xls") or filename.endswith(".json")):
            raise ValidationError("File harus berformat .json, .xlsx, atau .xls.")
